...
**Progreso: 74 ✅ implementadas · 2 ⚠️ parciales · 9 ❌ pendientes** (85 ítems)

### ✅ Implementadas (74)
A1, A2, A3, B1, B2, B3, C1, C2, D2, D3, E1, E2, E3, F1, F2, G1, H2, H3, H4, I1, I2, I3, I4, J1, K1, K2, K3, L1, L2, M1, M2, N1, N2, O1, O2, O3, O4, O5, P1, P2, P3, Q1, Q2, R1, R2, T1, T2, U1, U2, U3, U4, U5, V1, V2, G2, W1, W2, W4, X2, X3, Y1, Y2, Z1, Z2, Z3, Z4, AA1, AA2, AA3, AB1, AB2, AC1, AC2, AD1

### ⚠️ Parciales (2) — falta una pieza concreta
...
- Onboarding: **W3** (B/. — va con F3), **W5** (tutorial guiado)
