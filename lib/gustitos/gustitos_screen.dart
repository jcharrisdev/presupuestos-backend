  ...
  Future<void> _editarPresupuesto() async {
    ...
    final nuevo = await showDialog<double>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Presupuesto de gustitos', style: TextStyle(color: AppTheme.textPrimary, fontSize: 16)),
        content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('¿Cuánto quieres permitirte en gustitos cada mes? (0 = sin límite)',
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (tieneLimite) ...[
          ...
          GestureDetector(
            ...
            child: Text('Define un presupuesto mensual para controlar tus gustitos →',
...
class _GustitoTile extends StatelessWidget {
  ...
  _GustitoTile({required this.gustito, required this.onEliminar});

  static final _emocionColor = {
