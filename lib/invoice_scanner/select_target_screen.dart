          ...
          children: [
            ...
            if (!_verMas) ...[
              ...
              _BigOption(
                ...
                subtitle: 'Variable, alimentación, transporte… regístralo en tu mes',
              ...
              _BigOption(
                icon: Icons.bolt,
                title: 'Gustito',
                subtitle: 'Compra consciente por gusto — lleva su propio control',
                color: AppTheme.colorAhorro,
                onTap: () => _ir(CreateGustitoFromInvoiceScreen(invoice: invoice, firebaseUid: uid)),
              ),
              const SizedBox(height: 12),
              _BigOption(
                icon: Icons.tune,
                title: 'Más opciones',
                subtitle: 'Gasto existente, compartido, negocio, inventario, archivar…',
